...
### 📱 Calendar & Receipt Improvements

Your calendar now lets you start tracking time directly from any scheduled job. We've also improved the expense capture flow - receipt photos are now stored securely in the cloud.

#### What Changed
- Start a timer right from your calendar by tapping any job
- Receipt photos are uploaded automatically for safekeeping
- "Send Invoice" on job completion takes you to your invoices
- Tapping empty calendar slots shows the event creation form (full creation coming soon)
